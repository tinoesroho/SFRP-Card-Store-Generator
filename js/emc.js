...
document.getElementById("firstemc").innerHTML = "[big][big]~Standard Cards~[/big][/big]<br><br>" + standard[0] + "<br>" + standard[1] + "<br>" + standard[2] + "<br>" + standard[3] + "<br>" + standard[4] + "<br>" + standard[5] + "<br>" + standard[6] + "<br>" + standard[7] + "<br>" + standard[8] + "<br>" + standard[9] + "<br>" + standard[10] + "<br>" + standard[11] + "<br>" + standard[12] + "<br>" + standard[13] + "<br>" + standard[14] + "<br>" + standard[15] + "<br>" + standard[16] + "<br>" + standard[17] + "<br>" + standard[18] + "<br>" + standard[19] + "<br>" + standard[20] + "<br>" + standard[21] + "<br>" + standard[22] + "<br>" + standard[23];
